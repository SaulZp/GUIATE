...
mysql_query("UPDATE materias set e83='3' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e84='0' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e82='$temp' WHERE matricula='$_SESSION[username]'",$con);
