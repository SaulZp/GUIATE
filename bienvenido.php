...
<div id="nomenclatura">
	<h3>Nomenclatura</h3>
	<div id="ap">.</div><button class="button" value="">Materias Aprobadas</button>
	<div id="re">.</div><button class="button" value="">Materias Reprobadas</button>
	<div id="po">.</div><button class="button" value="">Materias por Cursar</button>
	<div id="en">.</div><button class="button" value="">Materias en curso</button><br>
</div><br>
