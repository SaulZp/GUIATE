...
mysql_query("UPDATE materias set e83='$temp' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e84='3' WHERE matricula='$_SESSION[username]'",$con);
