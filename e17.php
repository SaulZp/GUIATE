...
mysql_query("UPDATE materias set e15='1' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e16='1' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e17='$temp' WHERE matricula='$_SESSION[username]'",$con);

mysql_query("UPDATE materias set e28='3' WHERE matricula='$_SESSION[username]'",$con);
