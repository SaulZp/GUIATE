...
<body id="page-top">
    ...
    <header class="masthead">
      <div class="container">
        <img class="img-circle" src="img/fcc.png" alt="" widht="304" height="236">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <form method="POST" action="index.php">
              <div class="control-group">
               ...
               <div class="control-group">
                <div class="form-group floating-label-form-group controls">
                  <label>Email</label>
                  <input class="form-control" name="correo" type="email" placeholder="Email " required data-validation-required-message="Por favor ingresa tu correo electrónico">
                  <p class="help-block text-danger"></p>
                </div>
              </div>
              <div class="control-group">
            ...
            mysql_query("INSERT INTO usuarios(nombre,correo,contrasena)VALUES
            ('$_POST[nombre]','$_POST[correo]','$_POST[contrasena]')",$con);
