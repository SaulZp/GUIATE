...
mysql_query("UPDATE materias set e13='$temp' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e14='3' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e15='3' WHERE matricula='$_SESSION[username]'",$con);
