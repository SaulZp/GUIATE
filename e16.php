...
mysql_query("UPDATE materias set e16='$temp' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e17='3' WHERE matricula='$_SESSION[username]'",$con);
