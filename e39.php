...
mysql_query("UPDATE materias set e37='1' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e39='$temp' WHERE matricula='$_SESSION[username]'",$con);
