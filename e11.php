...
mysql_query("UPDATE materias set e11='$temp' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e12='3' WHERE matricula='$_SESSION[username]'",$con);
mysql_query("UPDATE materias set e13='0' WHERE matricula='$_SESSION[username]'",$con);
...
mysql_query("UPDATE materias set e22='3' WHERE matricula='$_SESSION[username]'",$con);
